...
public:
    ...
    *************************************************/
    bool set_light_source_param(int frequency, int duty_cycle, int timeout = 1);
    ...
    * speed     --  移动速度
    *************************************************/
    bool move_distance(int axis, int distance, int speed);
    ...
    * speed     --  移动速度
    *************************************************/
    bool move_position(int axis, int position, int speed);
   ...
   *************************************************/
     ...
     ************************************************/
    bool set_current_position_zero(int axis);
    ...
    **************************************************/
    bool send_command(const std::string& cmd, int timeout = 10, std::string* ret_string = nullptr);
